            ...
            <div className='mainLeadHero w-screen md:h-[62.99563rem] sm:h-96  md:flex md:justify-end sm:flex  sm:items-center '>
                <div className='w-[40rem] h-[28rem]  rounded-md bg-[#FFF3E3] mr-32  mt-5'>
                    <div className='mt-[5.81rem] ml-[2.56rem] text-start '>
                        ...
                        <p className='w-[34rem] h-[3.29rem]  text-black font-semibold leading-[1.5rem]'>Handcrafted Furniture: Where Artistry Meets Functionality, Your Space Elevated</p>
                        <p className='py-[1.45rem] px-[4rem] inline-flex items-start gap-[0.625rem] bg-black text-white mt-6 cursor-pointer rounded-md'>BUY NOW</p>
                    </div>
                </div>
            </div>
